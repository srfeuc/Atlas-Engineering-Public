---
Title: STP + EtherChannel Sandbox — Troubleshooting
Path: Labs/Lab-02-Cisco-Core/Packet-Tracer-Labs/STP-EtherChannel-Sandbox/Troubleshooting.md
Status: 📋 SCAFFOLD — symptom → cause → fix
Version: 0.1
Date: 2026-08-05
---
...
# STP + EtherChannel Sandbox — Troubleshooting

## Symptoms & search terms

> _Verbatim errors · plain phrases · aliases · keywords (the offline-briefcase findability standard, `ADR-0053` §5)._
